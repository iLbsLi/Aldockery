...
def switch_suggested_object_id(host_name: str, container_name: str) -> str:
    return f"{container_slug(container_name)}_{host_slug(host_name)}_docker"


def button_suggested_object_id(host_name: str, container_name: str, action: str) -> str:
    return f"{container_slug(container_name)}_{slugify_part(action)}_{host_slug(host_name)}_docker"
